...
\cventry{title}{Alfred - Conversational Shopping AI bot}{\textsc{NLP, Query optimisation, DialogFlow}}{}{}{ A Springer paper published on conversational shopping assistant bot. \emph{Springer paper} is under peer review. First draft of the 
...
\cventry{}{Text Summarize}{\textsc{NLTK, Python}}{}{}{ A working Text news Summarizer. The project takes a the web address as an input and find the main content using Beautiful Soup BS4 and then gives user the summary of the page. Made in collaboration with \href{ainpayal2494@gmail.com}{\color{blue}Payal Jain M.Tech.} GitHub repo -> \href{https://github.com/Arvind2222/Text_Summarization}{\color{blue}text Summarizer}}

\cventry{django}{Learning Log}{\textsc{Django}}{}{}{
...
\cventry{django}{Django Blog}{\textsc{Django}}{}{}{Blog using Django with MVC framework. My First website developed using a MVC framework. Learned how to configure and host on a heroku. }
...
\cventry{blog}{ghost}{\textsc{SSL,backend, DNS, A-records}}{}{}{ 
	Ghost Blog for the custom domain \href{https://arvibd.me}{\color{blue}arvibd.me}}

%--------------------------------------------------------------------

\section{Certification}

\cvitem{}{\textsc{Advanced Java Programming} \href{https://www.lynda.com/ViewCertificate/87EB180541944978A475DCD897BDF971}{\color{blue}Certificate}}


\cvitem{}{\textsc{Linux} \href{https://verify.edx.org/cert/4849aee4d06b4a7a9bc7f64a39e597d7}{\color{blue} Linux Certificate}}

\cvitem{}{\textsc{[Python, Optimisations, Generators]}  Optimizing Python Code
\href{https://www.lynda.com/ViewCertificate/0CAE94472BC34CAAA6A0CD43FF59F5FF}{\color{blue}Python Code Optimisations}}

\cvitem{}{\textsc{[Python, Itertools, Collections]}
Python 3 \href{https://www.lynda.com/ViewCertificate/2E7C5DD1E5D34E9C9AD0F5D216BB50E4}{\color{blue}Python 3 STL Certificate}}

\cvitem{}{\textsc{[iOS, Firebase]} \href{https://www.lynda.com/ViewCertificate/3030E12F35784A8581783FED832B4C32}{
\color{blue} iOS Development with Firebase Certificate
}}

\cvitem{}{
\textsc{[Java 9, Streams, Functional Programming]} 
Functional Programming with Streams in Java 9
\href{https://www.lynda.com/ViewCertificate/02E6485B128440089CEE2824B4984DAA}{
\color{blue}Java 9 Certificate}}

\cvitem{}{
\textsc{[Machine Learning, Python, Numpy]} Building a Recommendation System with Python Machine Learning \& AI \href{https://www.lynda.com/ViewCertificate/A2CBF88210064E8EB63D37049C9A81B8}{
\color{blue}
Certificate
}}

\cvitem{}{
\textsc{[Java, APIs, Collections]} 
Java Essential Training: Objects and APIs \href{https://www.lynda.com/ViewCertificate/95C5566F702A4D09BE270982886A5668}{
\color{blue}
Certificate
}}
...
\cvitem{algorithms}{I am always aware of the performance runtimes and their impact on the systems. My \href{https://www.codechef.com/users/arvind2222}{\color{blue}Codechef} profile. \href{https://www.dropbox.com/sh/rv418ekui895ewb/AAAO_Egco_T2gacyXpO2WJ3Za?dl=0}{\color{blue}ML Algorithms} [SVM, PCA, Logistic, ID3, Naive Bayes}
...
\cvitem{Running}{From 125Kg in my second year to a fit 15KM 78 Kg Runner. It taught me importance of \emph{discipline} in life than anything else. 
	I am BLUE \texttt{(ran more than 1000KM)} runner on \href{https://github.com/Arvind2222/arvind2222.github.io/blob/master/run/running.pdf}{\color{blue}BLUE} I complete 100KM run a month.}
